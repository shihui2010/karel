...
#from tfa.seq2seq.sampler import TrainingSampler, BasicDecoder, Sampler
#from tfa.rnn import RNNCell, LSTMCell, MultiRNNCell, OutputProjectionWrapper
from tensorflow.contrib.seq2seq import TrainingHelper, BasicDecoder, Helper
...
def build_rnn(train_or_test, cell, rnn_train_inputs, start_code_embed,
    ...
    (decoder_outputs, decoder_samples), final_decoder_state, _ = \
            tf.contrib.seq2seq.dynamic_decode(
                    #tfa.seq2seq.BasicDecoder(cell, helper, initial_state), scope=name)
