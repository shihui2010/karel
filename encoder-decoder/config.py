...
data_arg.add_argument('--colors', type=list, default=["red", "yellow"])
data_arg.add_argument('--shapes', type=list, default=["round", "square"])
...
# # of data
data_arg.add_argument('--num_train', type=int, default=500)#1000000)
data_arg.add_argument('--num_test', type=int, default=100)#5000)
data_arg.add_argument('--num_val', type=int, default=100)#5000)
data_arg.add_argument('--num_spec', type=int, default=5)
data_arg.add_argument('--num_heldout', type=int, default=5)
...
train_arg.add_argument('--max_step', type=int, default=1000)#100000000)
